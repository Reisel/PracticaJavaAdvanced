...
public class Citas extends javax.swing.JFrame {
    ...
    public Citas() {
        ...
        //cargar cmbDias
        for(Dias d:Dias.values()) cmbDias.addItem(d);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnAlta, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(txtNombre)
                        .addComponent(cmbDias, 0, 181, Short.MAX_VALUE)
    ...
    private void btnAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaActionPerformed
        ...
        Cita cita=new Cita(
                txtNombre.getText(),
                cmbDias.getItemAt(cmbDias.getSelectedIndex()),
                cmbTurno.getItemAt(cmbTurno.getSelectedIndex())
        );
        JOptionPane.showMessageDialog(this, "Se dio de alta la cita");
    ...
    private javax.swing.JComboBox<Dias> cmbDias;
